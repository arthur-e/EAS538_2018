...
One thing to note is that to calculate CIs for the sample mean, we need to make assumptions about the distribution of the sample mean. According to the CLT, a sample mean can be assumed to be normally distributed. We then can safely use SE of the mean to calculate the CI of the mean.
