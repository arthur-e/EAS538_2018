...
The `melt` function can make a data frame shift from "wide" form into "long" form. The `is.vars` argument means the variable that contains the identifier. The `measure.vars` argument means the variable(s) that contains the measurement.
...
Here's another [tutorial](http://seananderson.ca/2013/10/19/reshape.html) for you to review.
