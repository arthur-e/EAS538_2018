...
Once you set the working directory, you can start to read in the data you want to work on. Let's try to read in the data with `read.table("price.csv")` and name the output data frame `rent.US`.  
...
rent.US = read.table("price.csv", header = T, fill = T, sep = ",", quote = "")
```


```{r echo=FALSE, out.width=12}
rent.US = read.table("https://raw.githubusercontent.com/OscarFHC/EAS538_2018/master/Week2_EDA/price.csv", 
