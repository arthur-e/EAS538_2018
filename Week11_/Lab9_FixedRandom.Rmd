...
nwork = read.csv(file = "https://raw.githubusercontent.com/OscarFHC/EAS538_2018/master/Week11_/networking.csv", sep = ",", header = T,comment.char = "#")
head(nwork)
```
...
`degree`: the type of degree the student earned.    
...
nwork2 = read.csv(file = "https://raw.githubusercontent.com/OscarFHC/EAS538_2018/master/Week11_/networking2.csv", sep = ",", header = T,comment.char = "#")
head(nwork2)
nwork2$school=relevel(nwork2$school,ref='SEAS')
lmod2 = lm(wages~networking + school,data=nwork2)
summary(lmod2)
```
...
summary(mod)
```
Whoa! This looks different from the `lm` outputs you've seen up until now. 
